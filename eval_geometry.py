...
def evaluate_mesh(model_paths, mesh_gt, pred_mesh_types=['tsdf'], 
    ...
    mesh_pred_dict = {'tsdf': 'recon_womask_post.ply',
                      'poisson': 'recon_poisson_post.ply',
                      'tetrahedra': 'recon_tetrahedra.ply',
                    }
    for pred_mesh_type in pred_mesh_types:
        ...
        for method in os.listdir(exp_paths):
            full_dict[method] = {}
            mesh_pred = f'{model_paths}/{mesh_pred_file}'
    ...
    for method in os.listdir(exp_paths):
        ...
        for (idx, pred_depth_file) in tqdm(enumerate(pred_depth_files), desc='Evaluating depth'):
            ...
            if show_errormap:
                 ...
                 pred_depth_vis = write_image_info(visualize_depth(pred_depth, valid_mask=mask), "pred_depth")
